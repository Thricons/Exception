        ...
        if(event.getType() == Event.Type.PRE){
            ...
            if (curTarget != null) {
                ...
                if (hand.isCurrentMode("Vlamy")) {
                    ...
                    mc.getNetHandler().addToSendQueue(new C03PacketPlayer.C06PacketPlayerPosLook(mc.thePlayer.posX, mc.thePlayer.getEntityBoundingBox().minY, mc.thePlayer.posZ,rots[0], rots[1], mc.thePlayer.onGround));
                }
                ...
                if (hand.isCurrentMode("Hypixel")) {
                    ...
                    mc.getNetHandler().addToSendQueue(new C03PacketPlayer.C06PacketPlayerPosLook(mc.thePlayer.posX, mc.thePlayer.getEntityBoundingBox().minY, mc.thePlayer.posZ,yaw, pitch, mc.thePlayer.onGround));
                ...
                if (hand.isCurrentMode("Exhibition")) {
                    ...
                    if (facing.length > 0) {
                        mc.getNetHandler().addToSendQueue(new C03PacketPlayer.C06PacketPlayerPosLook(mc.thePlayer.posX, mc.thePlayer.getEntityBoundingBox().minY, mc.thePlayer.posZ,facing[0] + new Random().nextInt(2) - 1.0f, facing[1], mc.thePlayer.onGround));
                    }
                }
