...
public class Button
{
    ...
    public Button(final Module.Category category, final Module cheat, final int x, final int y) {
        this.opacity = 0.0;
        ...
        if(cheat == Exception.instance.moduleManager.getModuleByClass(HUD.class)){
